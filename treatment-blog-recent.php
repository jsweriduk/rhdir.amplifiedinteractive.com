...
<html lang="en">
<head>
    <title>Blog | Recently Added</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <?php
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Education'	and content != '' order by createDate desc");
        ...
        <section id="" >
            <!--div class="content-wrap">
                <div class="container clearfix"-->
                    ...
                    <div class="strike">
                        <h1 name="tube-recommended">Blog | Recently Added</h1>
                    </div>
