    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <?php
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Opinion' and subCat='CAADAC'	and content != '' order by createDate desc");
        ...
        <section id="" >
            <!--div class="content-wrap">
                <div class="container clearfix"-->
                    ...
                    <div class="strike">
                        <h1 name="tube-recommended">Opinion | CAADAC</h1>
                    </div>
