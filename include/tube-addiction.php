<?php
    ...
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Treatment Tube' and subCat='Drug Addiction Treatment' order by createDate desc ");
...
?>
	<?php include 'include/mashnav-get-content.php'; ?>
        <section id="">
                    <div class="strike">
                        <h1 name="tube-recommended">Drug Addiction</h1>
                    </div>

                    <div id="oc-addiction" class="owl-carousel posts-carousel">
