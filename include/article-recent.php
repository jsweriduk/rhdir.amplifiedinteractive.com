<?php
    ...
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='" . $maincat . "'  order by createDate desc ");
...
?>
        <section id="">
                    ...
                    <div class="">
                        <h1 class="treatment-heading find-treatment">Recently Published Articles:</h1>
                    </div>

                    <div id="article-recent" class="owl-carousel posts-carousel ">
                               ...
                               <div class="oc-item">
                                    <div class="ipost clearfix related-panel">
                                        ...
                                        <div class="entry-content">
                                            <?php echo   "<a href='article-content-detail.php?id=". $row['con_id'] . "'> <i>Uploaded </i> " . date('m.d.y',$cdate) . "</a>"; ?>
                                        </div>
										</div>
                                    </div>
                                </div>
