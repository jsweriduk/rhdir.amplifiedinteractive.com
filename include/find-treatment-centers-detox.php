...
$result=mysql_query("SELECT * FROM facilities WHERE 
                                                                    ...
                                                                    lower(svcText7) like '%detoxification%' order by createDate desc limit 12");

?>
<section id="">
                    <div class="">
                        <h1 class="treatment-heading find-treatment">Detox Treatment Centers</h1>
                    </div>

                    <div id="find-detox" class="owl-carousel posts-carousel">
