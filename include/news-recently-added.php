...
?> 
                    ...
                    <div class="strike">
                        <h1 name="ai-mental-health">Recently Added</h1>
                    </div>

                    <div id="news-recently-added" class="owl-carousel posts-carousel owl-theme owl-loaded ">
...
<script type="text/javascript">
                        ...
                        jQuery(document).ready(function($) {
                            ...
                            var ocImages = $("#news-recently-added");
