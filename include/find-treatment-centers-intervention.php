...
<section id="">
                    <div class="">
                        <h1 class="treatment-heading find-treatment">Intervention Treatment Services</h1>
                    </div>

                    <div id="find-intervention" class="owl-carousel posts-carousel">
                        ...
                        jQuery(document).ready(function($) {
                            ...
                            var ocImages = $("#find-intervention");
