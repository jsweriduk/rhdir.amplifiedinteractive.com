<script type="text/javascript">
                        jQuery(document).ready(function($) {
                            ...
                            var ocImages = $("#education-mental-health");
...
<?php
    ...
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Education' and subCat='Mental Health Disorders' and content != '' order by createDate desc limit 6 offset 7");
...
?> 
                    ...
                    <div class="strike">
                        <h1 name="ai-mental-health">Mental Health Disorders</h1>
                    </div>

                    <div id="education-mental-health" class="owl-carousel posts-carousel">
                        ...
                        ?>            
                               <div class="oc-item">
                                    <div class="ipost clearfix">
                                            <?php echo "<a href='treatment-tube-detail.php?id=". $row['con_id'] . "'><img src='". $imageurl . $image1 . "'></a>"; ?>
