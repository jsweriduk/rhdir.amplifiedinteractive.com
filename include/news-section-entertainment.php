<?php
    ...
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='News' and subCat='Entertainment' and content != '' order by createDate desc limit 1");
...
<div class="tab-pane fade active in news-content" id="tab2">
    <div class="media">
