...
?> 
                    ...
                    <div class="strike">
                        <h1 name="ai-mental-health">Recent</h1>
                    </div>

                    <div id="blog-recent" class="owl-carousel posts-carousel">
                               ...
                               <div class="oc-item">
                                    <div class="ipost clearfix">
                                        <div class="entry-image">
                                            <?php echo "<a href='/blog/=". $row['contentURL'] . "'><img src='". $imageurl . $image1 . "'></a>  </div>"; ?>
