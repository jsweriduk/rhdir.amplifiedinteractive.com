...
$result=mysql_query("SELECT * FROM facilities WHERE 
                                                                    ...
                                                                    lower(svcText7) like '%residential%' order by createDate desc limit 12");

?>
<section id="">
                    <div class="">
                        <h1 class="treatment-heading find-treatment">Residential Treatment Services</h1>
                    </div>

                    <div id="find-residential" class="owl-carousel posts-carousel">
