<?php
    ...
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Education' and subCat='Drug Addiction' and content != '' order by createDate desc limit 6");
...
?> 
                    ...
                    <div class="strike">
                        <h1 name="ai-mental-health">Alcohol Addiction</h1>
                    </div>

                    <div id="education-alcohol-addiction" class="owl-carousel posts-carousel owl-theme owl-loaded ">
...
<script type="text/javascript">
                        ...
                        jQuery(document).ready(function($) {
                            ...
                            var ocImages = $("#education-alcohol-addiction");
