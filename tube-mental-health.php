<?php
    ...
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Treatment Tube' and subCat='Mental Health Disorders' and content != '' order by createDate desc ");
...
?> 
        ...
        <section id="">
                    <div class="strike">
                        <span name="tube-recommended">Mental Health</span>
                    </div>

                    <div id="ai-mental-health" class="owl-carousel posts-carousel">
