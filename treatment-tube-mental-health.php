...
<html lang="en">
<head>
    <title>Treatment Tube | Mental Health Treatment</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <?php
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Treatment Tube' and subCat='Mental Health Treatment' order by createDate desc");
        ...
        <section id="" >
            <!--div class="content-wrap">
                <div class="container clearfix"-->
                    ...
                    <div class="strike">
                        <h1 name="tube-recommended">Treatment Tube | Mental Health Treatment</h1>
                    </div>
                               ...
                               <div class="video col-lg-4 col-md-6 col-sm-12">
                                    <div class="ipost clearfix card-content">
                                        <div class="entry-image">
                                            <?php echo "<a href='/video/". $row['contentURL'] . "'><img class='img-responsive' src='". $imageurl . $image1 . "'></a>  </div>"; ?>
