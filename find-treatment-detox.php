...
$result=mysql_query("SELECT * FROM facilities WHERE 
                                                                    ...
                                                                    lower(svcText7) like '%detoxification%' order by createDate desc limit 18");
...
<section id="">
				<div class="container">
                    <div class="">
						<br>
                        <h1 class="treatment-heading find-treatment" style="padding-left: 30px;">Detox Treatment Centers</h1>
                    </div>
