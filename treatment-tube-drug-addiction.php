...
<html lang="en">
<head>
    <title>Treatment Tube | Drug Addiction</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <?php
    $result=mysql_query("SELECT * FROM attContent WHERE mainCat='Treatment Tube' and subCat='Drug Addiction' order by createDate desc");
        ...
        <section id="" >
            <!--div class="content-wrap">
                <div class="container clearfix"-->
                    ...
                    <div class="strike">
                        <h1 name="tube-recommended">Treatment Tube | Drug Addiction</h1>
                    </div>
